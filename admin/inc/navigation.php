<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="user-panel brand-link pb-3 mb-3 d-flex">
          <div class="image">
          ...
          <div class="info brand-text">
            <a href="<?php echo base_url ?>admin/?page=user" class="d-block brand-text"><?php echo ucwords($_settings->userdata('firstname').' '.$_settings->userdata('lastname')) ?></a>
          </div>
        </div>
        <!-- Sidebar -->
          ...
          <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat mt-5" data-widget="treeview" role="menu" data-accordion="false">
