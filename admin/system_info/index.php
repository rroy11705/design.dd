		...
		<div class="card-body">
			<form action="" id="system-frm">
				<div id="msg" class="form-group">
					...
					<div class="form-group">
						<label for="short_name" class="control-label">Title</label>
						<input type="text" class="form-control form-control-sm" name="title" id="title" value="<?php echo  $_settings->info('title') ?>">
					</div>
				</div>
			<div class="form-group">
