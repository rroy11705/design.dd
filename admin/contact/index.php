					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="input-group">
			                    ...
			                    <input type="text" name="whatsapp" class="form-control" value="<?php echo isset($meta['whatsapp']) ? $meta['whatsapp'] : '' ?>">
		                	</div>
						</div>
						...
						<div class="form-group">
							<label for="" class="control-label">Behance Link</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
			                      <span class="input-group-text"><i class="fa fa-behance"></i></span>
			                    </div>
			                    <input type="text" class="form-control" name="behance" value="<?php echo isset($meta['behance']) ? $meta['behance'] : '' ?>">
		                	</div>
						</div>
						<div class="form-group">
							<label for="" class="control-label">Resume Link</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
			                      <span class="input-group-text"><i class="fa fa-resume"></i></span>
			                    </div>
			                    <input type="text" class="form-control" name="resume" value="<?php echo isset($meta['resume']) ? $meta['resume'] : '' ?>">
		                	</div>
						</div>
					</div>
				</div>
